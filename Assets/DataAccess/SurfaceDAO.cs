 ...
 * Date: 02/15/2015
 * 
 * SurfaceDAO will save new objects to a json file and also load existing objects from a josn file
 * 
 */
public class SurfaceDAO : iGameObjectDAO
{
	 ...
	 * Simple constructor.
	*/
	public SurfaceDAO (iFileLoader saveLoader, iFileLoader defaultLoader)
	{		
	...
	public List<LocalizedItem> GetLocalizedNames ()
	{
		...
		foreach (string key in saveContents.Keys)
			toReturn.Add (new LocalizedItem ("Ship", key));
