...
public class SubSurfaceDAO: iGameObjectDAO
{
	 ...
	 * Simple constructor.
	*/
	public SubSurfaceDAO (iFileLoader saveLoader, iFileLoader defaultLoader)
	{		
	...
	public List<LocalizedItem> GetLocalizedNames ()
	{
		...
		foreach (string key in saveContents.Keys)
			toReturn.Add (new LocalizedItem ("Submarine", key));
